...
const addUrl = (urls, loc, changefreq, priority) => {
...
const main = async () => {
  ...
  /*
   * Existing category navigation uses /shop?category=<slug>.
   * Only active categories with a slug are included.
   */
  ...
  /*
   * Existing public product route is /product/:id.
   * Use _id first because getProductById() accepts the product ID.
   */
